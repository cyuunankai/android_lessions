...
public class BaitDialogFragment extends DialogFragment {
	    ...
	    // Add action buttons
	           .setPositiveButton("±£´æ", new DialogInterface.OnClickListener() {
	               ...
	               public void onClick(DialogInterface dialog, int id) {
	                   // sign in the user ...
	            	   EditText etName = (EditText)v.findViewById(R.id.baitName);
	            	   EditText etDetail = (EditText)v.findViewById(R.id.baitDetail);
	            	   
	            	   mListener.onBaitDialogPositiveClick(BaitDialogFragment.this, etName.getEditableText().toString(), etDetail.getEditableText().toString());
